...
const ClaimFDModel = ({id,methods:{isUpdate,setIsUpdate}}) => {
  ...
  return (
    <>
         <button onClick={openModal} className="px-4 py-2 rounded border text-sky-600 border-sky-600 cursor-pointer ">Claim</button>
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  >
                 <h3 className='text-2xl text-sky-500'>  {data?.apply_for}</h3>
    <button onClick={closeModal} className='text-2xl text-sky-700 cursor-pointer outline-none bg-sky-100 rounded-full p-3'>    
    <IoClose/>
    </button>
                  ...
                  <div className="mt-2">
                       ...
                       <div className="py-5">
                       <button onClick={claimedFD} disabled={loading} className='w-full rounded py-2 flex justify-center items-center gap-x-2 bg-blue-500 disabled:bg-rose-800 text-white capitalize text-xl'>
                            <span>Claim</span>
